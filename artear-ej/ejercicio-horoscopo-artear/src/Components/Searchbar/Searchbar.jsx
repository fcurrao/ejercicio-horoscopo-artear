    ...
    return (<div className="bg-info d-flex flex-row flex-wrap justify-content-evenly">
        {window.innerWidth < 499 ? <>
            <div className="d-flex flex-row flex-wrap justify-content-center align-items-center">
                ...
                {(valueViewBy === "grilla") ? <div value="grilla" className="btnbtn" onClick={(e) => ChangeView(e)}><FontAwesomeIcon className="m-2 fa-2x" icon={faTableCellsLarge} /></div> : (valueViewBy === "lista") ? <div className="btnbtn" value="lista" onClick={(e) => ChangeView(e)}><FontAwesomeIcon className="m-4  fa-2x" icon={faList} /></div> : ""}
            </div>
        </> : <>
