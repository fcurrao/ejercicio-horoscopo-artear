...
import { HoroscopoList } from '../src/Components/HoroscopoList/HoroscopoList.jsx';
...
describe('HoroscopoListContainer', () => {
   ...
   it('deberia ser componente react', () => {
      const componente = <HoroscopoList />;
      expect(typeof componente).toBe('object');
      expect(componente.$$typeof.toString()).toBe('Symbol(react.element)');
   });
});
